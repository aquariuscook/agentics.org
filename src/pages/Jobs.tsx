      ...
      >
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="flex flex-col md:flex-row md:items-center justify-between p-6 border border-neutral-100 cursor-pointer group">
              <div>
              ...
              <div className="mt-4 md:mt-0 flex items-center gap-6">
                ...
                <button className="px-4 py-2 border border-brand text-brand text-xs font-bold uppercase tracking-widest">
                  Apply
                </button>
              </div>
            </div>
